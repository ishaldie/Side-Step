...
func _setup_visuals() -> void:
	...
	# Create themed background; keep legacy fallback visible if generation fails.
	...
	if not background_created:
		push_warning("[Game] Background generator failed; using fallback ColorRect background")
